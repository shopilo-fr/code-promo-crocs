 ...
 * Homepage: https://shopilo.fr/reductions/crocs.fr
 */

const SHOPILO_URL = "https://shopilo.fr/reductions/crocs.fr";
const STORE_NAME  = "Crocs";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-fr/code-promo-crocs)" }
  });
