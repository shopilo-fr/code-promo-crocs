#!/usr/bin/env python3
"""
Recuperation des codes promo Crocs depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/crocs.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/crocs.fr"
STORE_NAME = "Crocs"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Crocs depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-crocs)"
    }
    try:
